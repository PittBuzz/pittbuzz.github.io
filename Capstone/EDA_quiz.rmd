...
ames_train %>%
  mutate(Overall.Qual = as.factor(Overall.Qual), Overall.Cond = as.factor(Overall.Cond))
```
...
lot <- ggplot(ames_train, aes(x = Lot.Area, y = price)) +
  geom_point() +
  geom_smooth()

bed <- ggplot(ames_train, aes(x = Bedroom.AbvGr, y = price)) +
  geom_point() +
  geom_smooth()

over <- ggplot(ames_train, aes(x = Overall.Qual, y = price)) +
  geom_point() +
  geom_smooth()

year <- ggplot(ames_train, aes(x = Year.Built, y = price)) +
  geom_point() +
  geom_smooth()

grid.arrange(lot, bed, over, year, ncol = 2)
...
```{r Q5}
log_2 <- ggplot(ames_train, aes(x = log(area), y = log(price))) +
  geom_point() +
  geom_smooth()

log_p <- ggplot(ames_train, aes(x = area, y = log(price))) +
  geom_point() +
  geom_smooth()

log_a <- ggplot(ames_train, aes(x = log(area), y = price)) +
  geom_point() +
  geom_smooth()

log_n <- ggplot(ames_train, aes(x = area, y = price)) +
  geom_point() +
  geom_smooth()

grid.arrange(log_2, log_n, log_p, log_a, ncol = 2)
